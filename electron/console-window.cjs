...
const PANES = Object.freeze([
  ...
  // ("mixes notifications and decisions and avatars"). Bodies belong beside Stage and Cast.
  // Same bundle and the SAME deck-state subscription as the inbox — one component with a
  // view prop, so the two panes cannot drift.
  Object.freeze({
    id: "characters", label: "Characters", hint: "Bodies, spawns and the market",
